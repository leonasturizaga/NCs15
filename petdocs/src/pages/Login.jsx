...
//       } else if (response.data.message) {
//         setResponseMessage({ message: response.data.message, color: 'green' });
//         onLoginSuccess(nick); // Pass the nick to the parent component
...
//         <div className="hero-info">
//           <h3 className="title-h1">Login</h3>
//           <p>Si aún no te regsitraste, puedes hacerlo <Link to="/register">acá!</Link>.</p>
//           <form onSubmit={handleLogin}>
//             <div>
//               <label>Usuario:</label>
//               <input
